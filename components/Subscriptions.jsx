...
const FeatureBlock = () => {
  const data = [
    ...
    },
    {
      ...
      videoSrc: "../src/assets/studio.mp4",
    ...
    },
    {
      ...
      videoSrc: "../src/assets/junior.mp4",
      img: "../src/assets/junior.png",
      color: "bg-[#FFD89C]",
      Activities: 2,
      headtext: "text-[#1a1a1d]",
    },
